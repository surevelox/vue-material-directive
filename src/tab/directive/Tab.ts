    ...
    if (boundElement != null) {
      ...
      const _adapter = {
        ...
        activateIndicator(
          ...
          const contentEl = boundElement.querySelector(".mdc-tab-indicator") as HTMLElement;
        ...
        getContentOffsetLeft(): number {
          const contentEl = boundElement.querySelector(".mdc-tab__content") as HTMLElement;
      ...
      boundElement.onTabIndicatorInitialized = (e: Event) => {
        ...
        boundElement.mdcTabIndicator = eventArgs.detail.source.mdcIndicator;
      };
      ...
      boundElement.onSelectionChanged = (e: Event) => {
        ...
        if (eventArgs.detail.tabId == boundElement.id) {
          if (e.type == TabEvents.ACTIVATE) {
            boundElement.mdcTab?.activate(eventArgs.detail.clientRect);
