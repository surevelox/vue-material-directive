    ...
    if (boundElement != null) {
      ...
      const _adapter = {
        ...
        getScrollContentWidth(): number {
          return boundElement.scrollerEl?.scroller.content.offsetWidth;
        },
        ...
        activateTabAtIndex(
          ...
          boundElement.dataset["activetab"] = boundElement.tabList[index];          
        },
        ...
        getPreviousActiveTabIndex(): number {
          for (let i = 0; i < boundElement.tabList.length; i++) {
            if (boundElement.tabList[i] == boundElement.dataset["activetab"]) {
              return i;
            }
          }
          return -1;
      ...
      boundElement.UpdateTabList = () => {
        ...
        boundElement
          ...
          .forEach((item, index) => {
            tabs.push((item as HTMLElement).dataset.vmdcTab as string);
          });
